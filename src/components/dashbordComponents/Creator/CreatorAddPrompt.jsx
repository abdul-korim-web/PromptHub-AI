...
export function CreatorAddPrompt() {
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-6">
      ...
      <form className="bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-white/10 rounded-2xl p-5 md:p-6 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900 text-sm text-gray-900 dark:text-white focus:border-blue-500 outline-none transition cursor-pointer">
        ...
        <div className="pt-4 border-t border-gray-100 dark:border-white/5 flex justify-end gap-3">
          <button 
            type="button" 
            className="px-5 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 text-xs md:text-sm font-semibold text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/5 transition"
          >
            Cancel
          </button>
          <button 
            type="submit" 
            className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-xs md:text-sm font-bold shadow-sm shadow-blue-500/10 transition"
          >
            Submit Prompt
          </button>
        </div>
